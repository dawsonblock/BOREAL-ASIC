...
class MuJoCoPandaIface:
    ...
    def __init__(
        ...
        self.gripper_act_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_ACTUATOR, cfg.gripper_actuator)
    ...
    def close_gripper(self) -> None:
        ...
        if self.gripper_act_id is None or self.gripper_act_id < 0:
            return
        self.data.ctrl[self.gripper_act_id] = self.cfg.gripper_close_width
    ...
    def open_gripper(self, width: Optional[float] = None) -> None:
        ...
        self.data.ctrl[self.gripper_act_id] = float(w)
