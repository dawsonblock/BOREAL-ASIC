...
from panda.panda_context import PandaObs

if TYPE_CHECKING:
    from panda.mujoco_panda_iface import MuJoCoPandaIface
...
def min_contact_distance_proxy(model: "mujoco.MjModel", data: "mujoco.MjData") -> float:
    ...
    """
    if data.ncon > 0:
        # Contacts exist - could be with robot, object, or table
        # For more accuracy, filter by geom IDs
        return 0.0
    return 999.0
