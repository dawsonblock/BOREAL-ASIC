...
# Try to import SafetyValidator from vw_bandit, fall back to local definition
try:
    sys.path.insert(0, str(__file__).rsplit("/", 2)[0])
    from vw_bandit import SafetyValidator
except ImportError:
    # Define local SafetyValidator ABC if vw_bandit not available
...
from panda.panda_actions import PandaAction
